function $(selector){
	return new Cheny(selector) 
}

function Cheny (selector){
...
Cheny.prototype.attr = function(name , val){
	//如果只有一个参数且为字符串则为查询
...
Cheny.prototype.css = function(name , val){
	//一个参数且未字符串时 查询
	if (1 == arguments.length && typeof(arguments[0]) === 'string') {
...
Cheny.prototype.addClass = function(className){
...
Cheny.prototype.removeClass = function(className){
	//获取当前类名
	var oldName = this.attr('class'),
	//筛选出指定类名
...
Cheny.prototype.animate = function(cssName, target){
	this.timer = null ;
	that = this ; 
...
Cheny.prototype.on = function(eve , fn){
...
Cheny.prototype.off = function(eve , fn){
...
Cheny.prototype.html = function(val){
	if ("" == arguments[0]) {
